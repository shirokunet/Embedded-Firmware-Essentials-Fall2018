...
static void updateAnimation()
{
    ...
    static RGBData                     pixels6[LED_COUNT];
    static RGBData                     pixels7[LED_COUNT];
    static RGBData                     pixels8[LED_COUNT];
    static RGBData                     pixels9[LED_COUNT];
	static RGBData                     pixels10[LED_COUNT];
	static RGBData                     pixels11[LED_COUNT];
	static RGBData                     pixels12[LED_COUNT];
	static RGBData                     pixels13[LED_COUNT];
	static RGBData                     pixels14[LED_COUNT];
	static RGBData                     pixels15[LED_COUNT];
	static RGBData                     pixels16[LED_COUNT];
