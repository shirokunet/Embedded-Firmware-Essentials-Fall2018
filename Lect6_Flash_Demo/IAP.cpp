...
DEVICE_ID IAP::read_serial( void ) {

	// Modified on 10/11/2017 Wachenschwanz;  Changed return from int to struct containing Device ID
    ...
    sn.DIN_0 = IAP_result[1];
	sn.DIN_1 = IAP_result[2];
	sn.DIN_2 = IAP_result[3];
	sn.DIN_3 = IAP_result[4];
    return sn;
}
